...
insert  into `barang`(`barang_id`,`nama`,`jenis`,`harga`,`stok`,`sold`,`rating`,`unique_click`) values 
('1','Balenciaga','shoes',500000,1,1,5,1);
...
insert  into `htrans`(`htrans_id`,`user_id`,`paid`) values 
('HT0001','1','Y'),
('HT0002','1','N');
...
insert  into `imagepath`(`barang_id`,`namafile`) values 
('1','product1.jpg');
...
insert  into `rating`(`barang_id`,`user_id`,`rating`) values 
('1','1',5);
