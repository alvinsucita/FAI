            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/browse" style="color:#ffdb58">Browse</a></li>
                        <li><a href="/buy" style="color:#ffdb58">Buy</a></li>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <img src="profile_picture.jpg" class="user-image" alt="User Image">
                            ...
                            <li class="user-header bg-navy">
                                <img src="profile_picture.jpg" class="img-circle" alt="User Image">
